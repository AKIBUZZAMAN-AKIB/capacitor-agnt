...
> একই সময়ে ফোরগ্রাউন্ডে চ্যাট আর background-এ wake চললে দুটি হ্যান্ডেল একই SQLite ফাইলে লেখে।
> ইঞ্জিন `open_db()`-তে WAL + `busy_timeout=5000` সেট করে, তাই এটি lock-এ ক্র্যাশ করে না —
> দরকার হলে ৫ সেকেন্ড পর্যন্ত অপেক্ষা করে, ব্যর্থ হলে সেটাও telemetry-তে দেখা যায়।
